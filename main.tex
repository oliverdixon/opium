...
% I want to re-align this to one-hundred columns, as opposed to eighty, but
% that's unlikely to ever happen due to the difficulties that re-typing the
% bibliography would ensue.
...
realistically possessed over their own capital.}.
