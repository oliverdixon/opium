...
\newcommand{\wordcount}{TODO} % TODO
\newcommand{\wordcountabstract}{TODO} % TODO
...
were the sole factor leading to the Qing's dynastic decline, the extraordinary
amount of evidence, both from historians and contemporary documents
communicating the magnitude of the conflicts, allows a logical conclusion to be
reached that they were the clear primary factor.
...
\defbibnote{bib-wc}{%
        \textbf{%
                ...
                Word Count, excluding abstract: \wordcountabstract%
        }
}

\printbibliography[title={Cited Works}, heading=bibintoc, postnote=bib-wc]
