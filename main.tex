...
\fancypagestyle{stdhdr}{
	\fancyhf{}
	\fancyhead[R]{\textsc{\theauthor\space --- DIX18002469}}
...
\subsection{Treaty of Tientsin}

The \textit{Treaty of Tientsin} refers to a set of separate treaties signed between the Qing empire and the Western nations of Russia, France, the United Kingdom, and the United States
...
\autocite{Wang:2008} and is often regarded in China as another installation in the series of \textit{Unequal Treaties}. The following are extracts taken from the various \textit{Treaties of Tientsin}.

\input{sources/tientsin}
